...
const Orders = () => {
  ...
  const fetchOrders = async () => { 
    try {
      const response = await axios.get("https://foodapps-production.up.railway.app/api/order/all");
  ...
  const updateStatus = async (event, orderId) => {
    ...
    try {
      const response = await axios.patch(
        `https://foodapps-production.up.railway.app/api/order/status/${orderId}?status=${event.target.value}`
      );
